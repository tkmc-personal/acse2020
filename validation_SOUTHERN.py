...
root_dir = './01 Validation/Inputs/Southern_Hemisphere/wind_data.csv'
...
# plot results
root_dir = './01 Validation/Results/Southern_Hemisphere/'
plot_colour_map.plot(wind_P_data, 'WindModel', root_dir)

# ------------------------- SOLAR MODEL -------------------------------
# import irradiance resource
root_dir = './01 Validation/Inputs/Southern_Hemisphere/irradiance_data.csv'
solar_resource = import_data.import_resource(root_dir, 'SolarModel')

# set fixed variables
time_zone = 2.0  # The time zone in hours east of GMT.
lat = -37.80000000 # The latitude of the Solar PV facility, in degrees.
long = 144.96666667  # The longitude of the Solar PV facility, in degrees.
slope = 37.79  # Angle between the ground and the panel surface, degrees.
azimuth = 180.0  # The pole direction in which the panel faces, in degrees.
...
# ------------------------- STORAGE MODEL -------------------------------
# Import load data
root_dir = './01 Validation/Inputs/Southern_Hemisphere/load_data.csv'
...
root_dir = './01 Validation/HOMER results/Southern_Hemisphere/HOMER_validation_data.csv'
...
root = './01 Validation/Results/Southern_Hemisphere/'
...
axs.legend()
fig.savefig('./01 Validation/Results/Southern_Hemisphere/HomerModel_vs_ACSE9Model Power Output')
...
axs.set_title("Unmet Load Calculated in HOMER Model and ACSE9 Model" + note, y=1.08)
axs.set_xlabel("datetime (n = 0 to 8759; 24 hours, 365 days)")
...
axs.legend()
fig.savefig('./01 Validation/Results/Southern_Hemisphere/HomerModel_vs_ACSE9Model Unmet Load')
